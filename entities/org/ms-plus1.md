...
retired_reason: "captive - MS&AD group subsidiary. The FSA's own remedy for small institutions, leaning on a parent group's resources and knowledge, is available here, so the capability-gap pitch does not apply."
confidence: low
source: shotan-kyokai
first_seen: 2026-09-22
site: https://www.ms-plus1.com/
...
`qualified`. If it does not fit, retire it with a reason rather than deleting it:
    ...
    python3 tools/retire.py org-ms-plus1 "reason"

## Retired 2026-09-22

captive - MS&AD group subsidiary. The FSA's own remedy for small institutions, leaning on a parent group's resources and knowledge, is available here, so the capability-gap pitch does not apply.

---
id: org-sanko-syougakutanki
type: org
name: SANKO少額短期保険
name_ja: （株）SANKO少額短期保険
role: buyer
scope: company
country: JP
industry: [insurance]
...
site: http://www.sanko-syougakutanki.co.jp/
tags: [target, candidate, shotan-kyokai]
rel: []
links:
  - label: Corporate site
    url: http://www.sanko-syougakutanki.co.jp/
updated: 2026-09-22
---
...
`qualified`. If it does not fit, retire it with a reason rather than deleting it:
    ...
    python3 tools/retire.py org-sanko-syougakutanki "reason"

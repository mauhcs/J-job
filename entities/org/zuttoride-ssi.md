---
id: org-zuttoride-ssi
type: org
name: ZuttoRide少額短期保険
name_ja: ZuttoRide少額短期保険（株）
role: buyer
scope: company
country: JP
industry: [insurance]
...
site: https://zuttoride-ssi.co.jp/
tags: [target, candidate, shotan-kyokai]
rel: []
links:
  - label: Corporate site
    url: https://zuttoride-ssi.co.jp/
updated: 2026-09-22
---
...
`qualified`. If it does not fit, retire it with a reason rather than deleting it:
    ...
    python3 tools/retire.py org-zuttoride-ssi "reason"

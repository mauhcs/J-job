---
id: org-small-short-ins-rakuten
type: org
name: 楽天少額短期保険
name_ja: 楽天少額短期保険（株）
role: buyer
...
retired_reason: "captive - 楽天 group subsidiary. The FSA's own remedy for small institutions, leaning on a parent group's resources and knowledge, is available here, so the capability-gap pitch does not apply."
confidence: low
source: shotan-kyokai
first_seen: 2026-09-22
site: https://small-short-ins.rakuten.co.jp/
...
`qualified`. If it does not fit, retire it with a reason rather than deleting it:
    ...
    python3 tools/retire.py org-small-short-ins-rakuten "reason"

## Retired 2026-09-22

captive - 楽天 group subsidiary. The FSA's own remedy for small institutions, leaning on a parent group's resources and knowledge, is available here, so the capability-gap pitch does not apply.

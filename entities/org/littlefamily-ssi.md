---
id: org-littlefamily-ssi
type: org
name: リトルファミリー少額短期保険
name_ja: リトルファミリー少額短期保険（株）
role: buyer
scope: company
country: JP
industry: [insurance]
...
site: https://www.littlefamily-ssi.com/
tags: [target, candidate, shotan-kyokai]
rel: []
links:
  - label: Corporate site
    url: https://www.littlefamily-ssi.com/
updated: 2026-09-22
---
...
`qualified`. If it does not fit, retire it with a reason rather than deleting it:
    ...
    python3 tools/retire.py org-littlefamily-ssi "reason"

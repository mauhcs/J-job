...
id: org-sekifu-ssi
type: org
name: セキスイハイム不動産少額短期保険
name_ja: セキスイハイム不動産少額短期保険（株）
role: buyer
scope: company
country: JP
industry: [insurance]
...
retired_reason: "captive - 積水化学 group subsidiary. The FSA's own remedy for small institutions, leaning on a parent group's resources and knowledge, is available here, so the capability-gap pitch does not apply."
confidence: low
source: shotan-kyokai
first_seen: 2026-09-22
site: http://sekifu-ssi.co.jp/
tags: [target, candidate, shotan-kyokai]
rel: []
links:
  - label: Corporate site
    url: http://sekifu-ssi.co.jp/
updated: 2026-09-22
---
...
`qualified`. If it does not fit, retire it with a reason rather than deleting it:
    ...
    python3 tools/retire.py org-sekifu-ssi "reason"

## Retired 2026-09-22

captive - 積水化学 group subsidiary. The FSA's own remedy for small institutions, leaning on a parent group's resources and knowledge, is available here, so the capability-gap pitch does not apply.

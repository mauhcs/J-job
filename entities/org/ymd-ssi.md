...
retired_reason: "captive - ヤマダ group subsidiary. The FSA's own remedy for small institutions, leaning on a parent group's resources and knowledge, is available here, so the capability-gap pitch does not apply."
confidence: low
source: shotan-kyokai
first_seen: 2026-09-22
site: https://www.ymd-ssi.jp/
tags: [target, candidate, shotan-kyokai]
rel: []
links:
  - label: Corporate site
    url: https://www.ymd-ssi.jp/
updated: 2026-09-22
---
...
`qualified`. If it does not fit, retire it with a reason rather than deleting it:
    ...
    python3 tools/retire.py org-ymd-ssi "reason"

## Retired 2026-09-22

captive - ヤマダ group subsidiary. The FSA's own remedy for small institutions, leaning on a parent group's resources and knowledge, is available here, so the capability-gap pitch does not apply.

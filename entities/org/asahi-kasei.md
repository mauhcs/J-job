...
retired_reason: "captive - 旭化成 group subsidiary. The FSA's own remedy for small institutions, leaning on a parent group's resources and knowledge, is available here, so the capability-gap pitch does not apply."
confidence: low
source: shotan-kyokai
first_seen: 2026-09-22
site: https://www.asahi-kasei.co.jp/shoutan/
tags: [target, candidate, shotan-kyokai]
rel: []
links:
  - label: Corporate site
    url: https://www.asahi-kasei.co.jp/shoutan/
updated: 2026-09-22
---
...
`qualified`. If it does not fit, retire it with a reason rather than deleting it:
    ...
    python3 tools/retire.py org-asahi-kasei "reason"

## Retired 2026-09-22

captive - 旭化成 group subsidiary. The FSA's own remedy for small institutions, leaning on a parent group's resources and knowledge, is available here, so the capability-gap pitch does not apply.

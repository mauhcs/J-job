---
id: org-all-right-ins
type: org
name: All Right少額短期保険
name_ja: （株）All Right少額短期保険
role: buyer
scope: company
country: JP
industry: [insurance]
...
site: https://all-right-ins.co.jp/
tags: [target, candidate, shotan-kyokai]
rel: []
links:
  - label: Corporate site
    url: https://all-right-ins.co.jp/
updated: 2026-09-22
---
...
`qualified`. If it does not fit, retire it with a reason rather than deleting it:
    ...
    python3 tools/retire.py org-all-right-ins "reason"

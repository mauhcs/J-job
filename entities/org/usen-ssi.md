...
retired_reason: "captive - USEN group subsidiary. The FSA's own remedy for small institutions, leaning on a parent group's resources and knowledge, is available here, so the capability-gap pitch does not apply."
confidence: low
source: shotan-kyokai
first_seen: 2026-09-22
site: https://usen-ssi.co.jp/
tags: [target, candidate, shotan-kyokai]
rel: []
links:
  - label: Corporate site
    url: https://usen-ssi.co.jp/
updated: 2026-09-22
---
...
`qualified`. If it does not fit, retire it with a reason rather than deleting it:
    ...
    python3 tools/retire.py org-usen-ssi "reason"

## Retired 2026-09-22

captive - USEN group subsidiary. The FSA's own remedy for small institutions, leaning on a parent group's resources and knowledge, is available here, so the capability-gap pitch does not apply.

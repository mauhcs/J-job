...
id: org-safesafe
type: org
name: SBI常口セーフティ少額短期保険
name_ja: SBI常口セーフティ少額短期保険（株）
role: buyer
scope: company
country: JP
industry: [insurance]
...
retired_reason: "captive - SBI group subsidiary. The FSA's own remedy for small institutions, leaning on a parent group's resources and knowledge, is available here, so the capability-gap pitch does not apply."
confidence: low
source: shotan-kyokai
first_seen: 2026-09-22
site: http://www.safesafe.co.jp/
tags: [target, candidate, shotan-kyokai]
rel: []
links:
  - label: Corporate site
    url: http://www.safesafe.co.jp/
updated: 2026-09-22
---
...
`qualified`. If it does not fit, retire it with a reason rather than deleting it:
    ...
    python3 tools/retire.py org-safesafe "reason"

## Retired 2026-09-22

captive - SBI group subsidiary. The FSA's own remedy for small institutions, leaning on a parent group's resources and knowledge, is available here, so the capability-gap pitch does not apply.

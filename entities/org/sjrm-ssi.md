...
id: org-sjrm-ssi
type: org
name: セーフティージャパン・リスクマネジメント
name_ja: セーフティージャパン・リスクマネジメント（株）
role: buyer
scope: company
country: JP
industry: [insurance]
...
site: http://www.sjrm-ssi.co.jp/
tags: [target, candidate, shotan-kyokai]
rel: []
links:
  - label: Corporate site
    url: http://www.sjrm-ssi.co.jp/
updated: 2026-09-22
---
...
`qualified`. If it does not fit, retire it with a reason rather than deleting it:
    ...
    python3 tools/retire.py org-sjrm-ssi "reason"

...
rel: [stream-positioning, stream-publishing, note-sales-routes, note-model-building, org-tuj, artifact-flagship-paper, task-count-sangaku-prs, task-tuj-sangaku-capability]
updated: 2026-09-22
---
...
| | amount | note |
|---|---|---|
| FY2022, all private-sector research income | **¥138.6bn** | joint + commissioned research, clinical trials, IP; **+¥10.9bn (+8.5%) YoY** |
| FY2022, 共同研究 (joint research) alone | **¥97.7bn** | **+¥8.5bn (+9.5%) YoY** |
| FY2014 → FY2017, joint research | ¥41.6bn / 19,070 cases → ¥60.8bn / 25,451 cases | roughly +46% in three years |
...
**FY2023 average per joint-research contract: ¥3.296m.** And the distribution (MEXT, older
survey — confirm against a current year) is heavily skewed small:
...
**85% of Japanese industry-university joint research contracts are under ¥3m.** MEXT and METI
...
2. **Does finance do this?** Most 産学連携 by volume is engineering and medical. Whether
   Japanese financial institutions and fintechs commission academic research at any meaningful
   rate is not established — `task-count-sangaku-prs` is designed to measure it.
